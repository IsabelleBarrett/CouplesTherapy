...
public class SteamVR_ControllerEvents_ListenerExample : MonoBehaviour {
	...
	void Start () {
        ...
        GetComponent<SteamVR_ControllerEvents>().TouchpadClicked += new ControllerClickedEventHandler(DoGripClicked);
        GetComponent<SteamVR_ControllerEvents>().TouchpadUnclicked += new ControllerClickedEventHandler(DoGripUnclicked);
